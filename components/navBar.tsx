          ...
          >
            <ul className="mr-auto flex list-none flex-col lg:flex-row">
              <li className="flex items-center">
                ...
                >
                  <i className="far fa-file-alt leading-lg mr-2 text-lg text-blueGray-400" />{" "}
                  Docs
                </a>
              </li>
            </ul>
            <ul className="flex list-none flex-col lg:ml-auto lg:flex-row">
              ...
              <li className="flex items-center">
                <button
                  className="ml-3 mb-3 rounded bg-blueGray-700 px-4 py-2 text-xs font-bold uppercase text-white shadow outline-none transition-all duration-150 ease-linear hover:shadow-lg focus:outline-none active:bg-blueGray-600 lg:mr-1 lg:mb-0"
                  type="button"
                >
