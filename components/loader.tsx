...
export const Loader: FC = () => {
  return (
    ...
    //   <div
    //     className="spinner-border inline-block  h-8 w-8 animate-spin rounded-full border-4 text-ter"
    //     role="status"
    //   >
    //     <span className="visually-hidden text-ter">.</span>
    //   </div>
    // </div>
    <div
      role="status"
    ...
    >
      <svg
        aria-hidden="true"
        className="mr-2 inline h-8 w-8 animate-spin fill-ter text-gray-200 dark:fill-secondary dark:text-gray-600"
        viewBox="0 0 100 101"
        fill="none"
